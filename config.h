...
static const char col_carcosa[]     = "#cccc00";
static const char *colors[][3]      = {
        /*               fg         bg         border   */
        [SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
        [SchemeSel]  = { col_black, col_carcosa, col_carcosa },
};

/* tagging */
static const char *tags[] = { "c&c", "web", "phd-main", "phd2-corrections", "cheri/zephyr", "BaseFx-main", "BaseFx-remote", "personal1", "personal2"};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_m,      spawn,          {.v = moodcmd } },
    ...
    // wallpaper
    { MODKEY|ShiftMask,             XK_r,                       spawn, {.v = randomwallpaper } },
    { MODKEY,                       XK_r,                       spawn, {.v = reloadMenuBar } },
};
